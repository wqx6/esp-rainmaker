...
//        esp_rmaker_device_add_cb(matter_ctrl_service, NULL, NULL);
//
//        s_attributes_param = esp_rmaker_param_create(ESP_MATTER_CONTROLLER_DATA_PARAM_NAME, ESP_MATTER_CONTROLLER_DATA_PARAM_TYPE, esp_rmaker_obj("{}"), PROP_FLAG_READ);
//        esp_rmaker_device_add_param(matter_ctrl_service, s_attributes_param);
//
//        esp_rmaker_device_add_param(
//            matter_ctrl_service, esp_rmaker_param_create(ESP_MATTER_CONTROLLER_DATA_VERSION_PARAM_NAME, ESP_MATTER_CONTROLLER_DATA_VERSION_PARAM_TYPE,
...
{
    VerifyOrReturnError(params, ESP_ERR_INVALID_ARG);
    s_attributes_param = params;
